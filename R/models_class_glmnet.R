...
model_quali_early_glm <- function(data = clean_data()) {
  ...
  metrics_multi <- yardstick::metric_set(yardstick::accuracy, yardstick::kap, yardstick::mcc, yardstick::mn_log_loss,
                                         yardstick::roc_auc)
  metrics_binary <- yardstick::metric_set(yardstick::ppv, yardstick::npv, yardstick::spec, yardstick::sens,
  ...
  pole_mod <- parsnip::parsnip::logistic_reg(penalty = tune::tune(), mixture = tune::tune()) %>%
  ...
  position_mod <- parsnip::parsnip::logistic_reg(penalty = tune::tune(), mixture = tune::tune()) %>%
    parsnip::set_mode("classification") %>%
    parsnip::set_engine("glmnet", nthread = 4)
