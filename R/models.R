...
model_results <- function(grid, data = clean_data()) {
  ...
  message("Win Model with ", round(tune::collect_metrics(win_final_fit) %>%
    dplyr::filter(.data$.metric == "accuracy") %>%
    dplyr::pull(".estimate"), 4), "% accuracy and ", round(tune::collect_metrics(win_final_fit) %>%
    dplyr::filter(.data$.metric == "roc_auc") %>%
    dplyr::pull(".estimate"), 4), " auc.")
  ...
  message("Podium Model with ", round(tune::collect_metrics(podium_final_fit) %>%
    dplyr::filter(.data$.metric == "accuracy") %>%
    dplyr::pull(".estimate"), 4), "% accuracy and ", round(tune::collect_metrics(podium_final_fit) %>%
    dplyr::filter(.data$.metric == "roc_auc") %>%
    dplyr::pull(".estimate"), 4), " auc.")
  ...
  message("T10 Model with ", round(tune::collect_metrics(t10_final_fit) %>%
    dplyr::filter(.data$.metric == "accuracy") %>%
    dplyr::pull(".estimate"), 4), "% accuracy and ", round(tune::collect_metrics(t10_final_fit) %>%
    dplyr::filter(.data$.metric == "roc_auc") %>%
    dplyr::pull(".estimate"), 4), " auc.")
  ...
  message("Finishing Model with ", round(tune::collect_metrics(finish_final_fit) %>%
    dplyr::filter(.data$.metric == "accuracy") %>%
    dplyr::pull(".estimate"), 4), "% accuracy and ", round(tune::collect_metrics(finish_final_fit) %>%
    dplyr::filter(.data$.metric == "roc_auc") %>%
    dplyr::pull(".estimate"), 4), " auc.")
  ...
  message("Position Model with ", round(tune::collect_metrics(position_final_fit) %>%
    dplyr::filter(.data$.metric == "accuracy") %>%
    dplyr::pull(".estimate"), 4), "% accuracy and ", round(tune::collect_metrics(position_final_fit) %>%
    dplyr::filter(.data$.metric == "roc_auc") %>%
    dplyr::pull(".estimate"), 4), " auc.")
