...
* `chart_driver_championship_odds()`, `chart_driver_championship_points()`, and `chart_constructor_championship_points()` now plot round-by-round championship odds and points progressions (@pbulsink, #23).
